...
msg.TheRank =  'TELEGRAM DEV'
msg.Rank = 1
elseif msg.sender_user_id_ == 1610557559 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
elseif msg.sender_user_id_ == 905128847 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
elseif msg.sender_user_id_ == 1753323063 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/devsonicx/mafia/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/devsonicx/mafia/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/devsonicx/mafia/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/devsonicx/mafia/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/devsonicx/mafia/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/devsonicx/mafia/master/plugins/games.lua','./plugins/games.lua')
